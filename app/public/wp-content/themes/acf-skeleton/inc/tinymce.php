...
**/
  ...
  * @return array
  */
 function os_mce_editor_buttons( $buttons ) {
 	array_unshift( $buttons, 'styleselect' );
 	return $buttons;
 }
 add_filter( 'mce_buttons_2', 'os_mce_editor_buttons' );
  ...
  * @return array
  */
 function os_mce_before_init( $settings ) {
 ...
 add_filter( 'tiny_mce_before_init', 'os_mce_before_init' );
